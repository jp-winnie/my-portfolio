...
export default function Projects () {
        ...
        <section className="portfolio--section" id="Projects Section">
            <div className="portfolio--container-box">
                <div className="portfolio--container">
                    <p className="portfolio--sub--title">Recent Projects</p>
                    <h2 className="portfolio--section--heading">My Portfolio</h2>
                </div>
                <div>
                     <button className="portfolio--button--github"
                     onClick={() => window.open("https://github.com/jp-winnie", "_blank")}
                     >
  ...
  Visit My Github
            ...
            <div className="portfolio--section--container">
                ...
                <a href="https://tinyurl.com/foodsnap2023" target="_blank" rel="noopener noreferrer" className="portfolio--link">
                Visit the Website
                <svg
                  xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 20 19" fill="none"
                >
                  <path
                    d="M4.66667 1.66675H18V15.0001M18 1.66675L2 17.6667L18 1.66675Z" stroke="currentColor" stroke-width="2.66667" stroke-linecap="round" stroke-linejoin="round"
                  />
                </svg>
                </a>           
          </div>
